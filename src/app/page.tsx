...
import { ArrowRight, Code2, Server, Rocket, ChevronRight, Building2, Shield, Zap, Users, LineChart, Clock } from 'lucide-react';
      ...
      <div className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Let's discuss how Pikebridge can help transform your digital presence with scalable, secure solutions.
          </p>
          <a href="/contact">
            <button className="bg-emerald-600 text-white px-8 py-4 rounded-lg hover:bg-emerald-700 transition flex items-center gap-2 mx-auto">
